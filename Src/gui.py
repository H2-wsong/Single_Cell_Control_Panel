...
class MainWindowUI:
    ...
    def setupUi(self, MainWindow):
        ...
        status_layout.addLayout(interval_layout, 0, 3)

        status_layout.addWidget(QLabel("CSV Data Directory:"), 1, 0)
        MainWindow.auto_csv_dir_edit = QLineEdit(MainWindow.DEFAULT_AUTO_CSV_DIR)
        status_layout.addWidget(MainWindow.auto_csv_dir_edit, 1, 1, 1, 2)
        MainWindow.auto_browse_csv_dir_button = QPushButton("Browse...")
        status_layout.addWidget(MainWindow.auto_browse_csv_dir_button, 1, 3)
        status_layout.setColumnStretch(1, 1); status_layout.setColumnStretch(2, 1)

        logging_group = QGroupBox("Logging Control")
        ...
        logging_layout.addWidget(QLabel("Log Interval (s):"))
        ...
        MainWindow.master_toggle_logging_button = QPushButton("Start Logging")
        ...
        MainWindow.relay_open_button = QPushButton("Relay Open")
        MainWindow.relay_open_button.setEnabled(False)
        MainWindow.relay_close_button = QPushButton("Relay Close")
        ...
        valve_group = QGroupBox("Relay Auto Control (Charge Step Only)")
